...
class MyEventsViewController: UIViewController {
    ...
    private var titles:[String] = {
        return [favouriteType.allCases.first?.rawValue ?? ""]
    }()
...
extension MyEventsViewController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,MenuBarDelegate {
...
extension MyEventsViewController:FriendsCollectionViewCellDelegate {
...
extension MyEventsViewController:SegmentedControlDelegate {
